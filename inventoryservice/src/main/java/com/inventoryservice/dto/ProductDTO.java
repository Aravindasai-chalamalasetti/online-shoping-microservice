...
@Schema(
        name = "Product",
        description = "This is used to hold Product information"
)
public class ProductDTO {
    @Schema(
            description = "This is Product id",example = "bfd666"
    )
    private String productId;
    @Schema(
            description = "This is storage capacity",example = "256 Gb"
    )
    ...
    @Schema(
            description = "This is Product name",example = "Sony Xperia 12"
    )
    ...
    @Schema(
            description = "mention Product price",example = "129999"
    )
    ...
    @Schema(
            description = "show ramType information"
    )
    @NotNull(message = "ramType can't be empty")
    private RamTypeDTO ramType;
    @Schema(
            description = "show storageType information"
    )
